import{_ as s,c as n,o as a,a4 as p}from"./chunks/framework.BtaI5osv.js";const m=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"C++/QT/QT 线程同步.md","filePath":"C++/QT/QT 线程同步.md"}'),l={name:"C++/QT/QT 线程同步.md"},e=p(`<h2 id="线程同步" tabindex="-1">线程同步 <a class="header-anchor" href="#线程同步" aria-label="Permalink to &quot;线程同步&quot;">​</a></h2><h4 id="原子访问" tabindex="-1">原子访问 <a class="header-anchor" href="#原子访问" aria-label="Permalink to &quot;原子访问&quot;">​</a></h4><p>所谓原子访问，指的是一个线程在访问某个资源的同时能够保证没有其他线程会在同一时刻访问同一资源。</p><p>示例：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>long g_x=0;</span></span>
...
<span class="line"><span>    g_x++;</span></span>
<span class="line"><span>    return 0;</span></span>
<span class="line"><span>}</span></span></code></pre></div><p>两个线程运行完 g_x是等于2吗？</p><p>正确做法： 使用原子函数改进</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>long g_x=0;</span></span>
...
<span class="line"><span>    InterlockedExchangeAdd(&amp;g_x,1);</span></span>
<span class="line"><span>    return 0;</span></span>
<span class="line"><span>}</span></span></code></pre></div><p>代码示例</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>/*</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>    return 0;</span></span>
<span class="line"><span>}</span></span></code></pre></div><h4 id="关键代码段" tabindex="-1">关键代码段 <a class="header-anchor" href="#关键代码段" aria-label="Permalink to &quot;关键代码段&quot;">​</a></h4><p>关键段(Critical Section)是一小段代码，它在执行之前需要独占一些共享资源的访问权。这里的原子方式是代码除了当前线程之外，没有其他任何线程会同时访问该资源。当然系统仍然可以暂停当前线程去调度其他线程。但是在当前线程离开关键段之前，系统是不会去调度任何想要访问统一资源的其他线程的。</p><p>关键代码段的使用：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>CRITICAL_SECTION g_cs;</span></span>
<span class="line"><span></span></span>
<span class="line"><span>EnterCriticalSection(&amp;g_cs);</span></span>
<span class="line"><span>//... 处理公共资源代码</span></span>
<span class="line"><span>LeaveCriticalSection(&amp;g_cs);</span></span></code></pre></div><p>代码示例</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>/**</span></span>
...
<span class="line"><span>);</span></span></code></pre></div><p>一旦事件已经创建，就可以直接控制它的状态</p><p>将事件改为触发状态</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>BOOL SetEvent(HANDLE hEvent);</span></span></code></pre></div><p>将该事件改为未触发状态</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>BOOL ResetEvent(HANDLE hEvent);</span></span></code></pre></div><p>使得事件变为触发状态，然后立即又变为未触发状态，通知一次</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>BOOL PulseEvent(HANDLE hEvent);</span></span></code></pre></div><p>代码示例</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>/**</span></span>
...
<span class="line"><span>);</span></span></code></pre></div><p><strong>打开在其他进程中创建的信号量</strong></p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>HANDLE OpenSemaphore(</span></span>
...
<span class="line"><span>);</span></span></code></pre></div><p><strong>在线程离开对共享资源的处理时，释放信号量</strong></p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>BOOL ReleaseSemaphore(</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>    return 0;</span></span>
<span class="line"><span>}</span></span></code></pre></div><h4 id="互斥量内核对象" tabindex="-1">互斥量内核对象 <a class="header-anchor" href="#互斥量内核对象" aria-label="Permalink to &quot;互斥量内核对象&quot;">​</a></h4><p>互斥量内核对象用来确保一个线程独占对一个资源的访问。互斥量包含了一个使用计数、线程ID和一个递归计数。互斥量和关键段的行为完全相同。但是互斥量是内核对象，而关键段是用户模式下的同步对象。</p><p>线程ID用来标识当前占用这个互斥量的是系统中的哪个线程，递归计数表示这个线程占用该互斥量的次数。互斥量有很多用途，它们是使用最为频繁的内核对象之一。它们一般用来对多个线程访问的同一块内存进行保护。互斥量可以确保正在访问内存块的任何线程独占对内存块的访问权，这样就维护了数据的完整性。互斥量只能用于互斥，不能用于同步。</p><p>互斥量的使用规则：</p><ul><li>如果线程ID为0 （无效线程ID），那么该互斥量不为任何线程所占用，它处于触发状态。可以理解为：无人使用，即触发。</li><li>如果线程ID为非零值，那么有一个线程已经占用了该互斥量，他处于未触发状态。</li><li>与所有其他内核对象不同，操作系统对互斥量进行了特殊处理，允许他们违反一些常规的规则。</li></ul><p><strong>创建互斥量</strong></p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>HANDLECreateMutex(</span></span>
...
<span class="line"><span>);</span></span></code></pre></div><p>第一个参数表示安全控制，一般直接传入NULL。</p><p>第二个参数用来确定互斥量的初始拥有者。 如果传入TRUE表示互斥量对象内部会记录创建它的线程的线程ID号并将递归计数设置为1，由于该线程ID非零，所以互斥量处于未触发状态。 如果传入FALSE，那么互斥量对象内部的线程ID号将设置为NULL，递归计数设置为0，这意味互斥量不为任何线程占用，处于触发状态。</p><p>第三个参数用来设置互斥量的名称，在多个进程中的线程就是通过名称来确保它们访问的是同一个互斥量。</p><p><strong>打开互斥量</strong></p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>HANDLEOpenMutex(</span></span>
<span class="line"><span> DWORD dwDesiredAccess,//访问权限</span></span>
<span class="line"><span> BOOL bInheritHandle,//继承标志</span></span>
<span class="line"><span> LPCTSTR lpName //名称</span></span>
<span class="line"><span>);</span></span></code></pre></div><p><strong>触发互斥量</strong></p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>BOOL ReleaseMutex (HANDLE hMutex)</span></span></code></pre></div><p>访问互斥资源前应该要调用等待函数，结束访问时就要调用ReleaseMutex()来表示自己已经结束访问，其它线程可以开始访问了</p><p><strong>清理互斥量</strong></p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>BOOL CloseHandle(HANDLE hObject);</span></span></code></pre></div><p>代码实例</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>/**</span></span>
...
<span class="line"><span>}</span></span></code></pre></div><h4 id="qsemphore" tabindex="-1">QSemphore <a class="header-anchor" href="#qsemphore" aria-label="Permalink to &quot;QSemphore&quot;">​</a></h4><p>Qt中的信号量是由QSemaphore类提供的，信号量可以理解为互斥量功能的扩展，互斥量只能锁定一次而信号量可以获取多次，它可以用来保护一定数量的同种资源。</p><p>acquire(n)函数用于获取n个资源，当没有足够的资源时调用者将被阻塞直到有足够的可用资源。release(n)函数用于释放n个资源。</p><p>QSemaphore类还提供了一个tryAcquire(n)函数，在没有足够的资源是该函数会立即返回。 一个典型的信号量应用程序是在两个线程间传递一定数量的数据(DataSize)，而这两个线程使用一定大小(BufferSize)的共享循环缓存(生产者-消费者模型)</p><p>临界区资源</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>QSemaphore freeSpace(BufferSize);  </span></span>
<span class="line"><span>QSemaphore usedSpace(0);</span></span></code></pre></div><p>生产者：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>freeSpace.acquire();</span></span>
<span class="line"><span>...生产</span></span>
<span class="line"><span>usedSpace.release();</span></span></code></pre></div><p>消费者：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>usedSpace.acquire();</span></span>
<span class="line"><span>...消费</span></span>
<span class="line"><span>freeSpace.release();</span></span></code></pre></div><p>代码示例</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>#include &lt;QCoreApplication&gt;</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>    return a.exec();</span></span>
<span class="line"><span>}</span></span></code></pre></div><h4 id="无锁编程" tabindex="-1">无锁编程 <a class="header-anchor" href="#无锁编程" aria-label="Permalink to &quot;无锁编程&quot;">​</a></h4><p>最快的同步方式是不同步</p><p>无锁编程</p>`,110),i=[e];function c(t,r,o,d,h,u){return a(),n("div",null,i)}const b=s(l,[["render",c]]);export{m as __pageData,b as default};
